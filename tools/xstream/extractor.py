...
from tools.xstream.extractors.hls.parser import HLSParser
from tools.xstream.extractors.hls.stream import HLSStream
from tools.xstream.extractors.dash.parser import DASHParser
from tools.xstream.extractors.dash.stream import DASHStream
from tools.xstream.extractors.mss.parser import MSSParser
from tools.xstream.extractors.mss.stream import MSSStream
...
class Extractor:
    ...
    def parse_as_hls(self, uri_type: str, uri: str, content: str, parent_stream: HLSStream = None) -> List[HLSStream]:
        _streams = HLSParser(self.logger, self.args, uri_type).parse(
    ...
    def parse_as_mss(self, uri_type: str, uri: str, content: str, parent_stream: MSSStream = None) -> List[MSSStream]:
        streams = MSSParser(self.logger, self.args,
                            uri_type).parse(uri, content)
        return streams
